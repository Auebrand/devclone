/**
 * content.js — roda dentro da pagina.
 * Responsabilidades:
...
(() => {
  ...
  // Assim o background lê e reescreve sem tabs.sendMessage e sem host access.
  try {
  ...
  // Mantém somente respostas síncronas no canal runtime.
  try {
